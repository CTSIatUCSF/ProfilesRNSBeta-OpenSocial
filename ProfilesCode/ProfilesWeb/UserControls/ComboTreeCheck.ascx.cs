...
public partial class ComboTreeCheck : System.Web.UI.UserControl
{
    ...
    public void ResetContent()
    {
        if (!IsPostBack)
        {
            ...
            lSelectText.Attributes.Add("onclick", String.Format("ShowMainContent('{0}'); return false;", ClientID));
            //HtmlImage
        }
    ...
    protected void rMaster_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType==ListItemType.Item || e.Item.ItemType ==  ListItemType.AlternatingItem)
        {
            ...
            l_imgExpand.Attributes.Add("class", l_isExpand ? "CTCprefixExpanded" : "CTCprefixCollapsed");
