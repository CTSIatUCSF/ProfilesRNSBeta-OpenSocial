...
CodeFile="ForDevelopers.aspx.cs" Title="For Developers" Inherits="ForDevelopers" %>
...
<ul  class="square">
  <li>Over 85,000 publications, research narratives, photos, UCSF Campus Locator System</li>
  <li>More than 2600 UCSF faculty and academic leaders</li>
  <li>More than 1000 UCSF postdoctoral scholars</li>
  <li>Soon to include UCSF residents, fellows, etc.</li>
  <li>Updated automatically as new publications become available and contact data change</li>
</ul>
...
Moriah Hart, Analyst, San Francisco General Hospital, UCSF
</p>
</blockquote>
...
<div style="width:270px; float:left;"> 
  <h3>JSON API</h3>
  <ul class="square">
    <li>Publication data by researcher</li>
    <li>Display researcher photos</li>
    <li>5 minutes to plug our data into your site using JavaScript, or any server-side language</li>
  </ul>
</div>
<div style="width:270px; padding-left:15px; float:left;"> 
  <h3>XML</h3>
 <ul class="square">
    <li>Publication data</li> 
    <li>Display researcher photos</li>
    <li>Research narratives and awards</li>  
    <li>UCSF Campus Locator System information</li>
    <li>Flexible queries</li> 
    <li>See a demo at <a href="http://cfar.ucsf.edu/cfar?page=directory-00-00&post=1&typeSearch=profile&personIdSearch=1194"
    target="_new" title="See a demo">UCSF's Center for AIDS Research (CFAR)</a></li>
  </ul>
</div>
